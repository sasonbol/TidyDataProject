...
o	The (t) and (f) prefixes indicate time and frequency components, respectively
o	X, Y and Z indicates the axis of the 3D signal
o	Abbreviations for each component are shown between brackets in the figure below
o	The mean &/or the standard deviation were measured for the following features (to understand the relations and abbreviations of the these features, refer to figure1 below):
...
o	For each measured feature, the number of (*) symbol in figure1 indicates the variables presented in (tidydf) dataset
o	For better understanding of the variable names, walk through figure1 from left to right
